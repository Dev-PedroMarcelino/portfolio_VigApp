...
/**
 * Centerpiece: the measured drawing. Radix tabs move between three rooms and
 * each one plots itself from scratch — the studio's argument that the project
 * is decided on paper, made literal. Switching tabs unmounts the previous
 * panel, so every room draws fresh.
 */
export function Spaces({ content }: { content: PrumoContent["spaces"] }) {
